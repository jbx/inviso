...
var searchFields = [
  ...
  { label: 'Finished', id: 'stop', fields: ['mapred.job.stop'], active: true},
  ...
  { label: 'Links', id: 'links', fields: ['_links'], active: false},
  { label: 'Workflow ID', id: 'workflow_id', fields: ['genie.job.id', 'hive.query.id', 'pig.script.id', 'cascading.flow.id', 'crunch.planner.dotfile.outputdir'], active: true},
  { label: 'Genie Name', id: 'genie_name', fields: ['genie.job.name'], active: false},
  ...
  { label: 'Cascading Flow Id', id: 'query_id', fields: ['cascading.flow.id'], active: false},
  { label: 'Crunch Dotplanner File', id: 'query_id', fields: ['crunch.planner.dotfile.outputdir'], active: false},
  ...
  { label: 'Started', id: 'start', fields: ['mapred.job.start'], active: true},
  ...
  { label: 'Mapreduce Version', id: 'version', fields: ['mapreduce.version'], active: false},
